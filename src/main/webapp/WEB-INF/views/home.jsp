...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="resources/app/styles/style.css"/>
    ...
    <body ng-app="clientApp">
		...
		<div class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
					<ul class="nav">
						<li><a href="#/plus/people/me">Google+</a></li>

						<li><a href="#/drive/listFiles">Google Drive</a></li>
					</ul>
        ...
        <script src="resources/app/scripts/controllers/drives.js"></script>
        <script src="resources/app/scripts/controllers/peoplesearch.js"></script>
