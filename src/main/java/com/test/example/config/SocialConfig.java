...
import com.test.example.user.SecurityContext;
import com.test.example.user.SimpleConnectionSignUp;
import com.test.example.user.SimpleSignInAdapter;
import com.test.example.user.User;
